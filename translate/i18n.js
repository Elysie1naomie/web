...
const TRANSLATIONS = {
  fr: {
    ...
    hero: { title:"L'éducation de qualité,", highlight:"accessible à tous.", subtitle:"Des milliers de ressources pédagogiques, des quiz intelligents et un assistant IA, pour chaque élève camerounais.", play_store:"Play Store", app_store:"App Store", stat_students:"étudiants", stat_resources:"ressources", stat_free:"Gratuit à 100%" },
    ...
    stats: { label1:"étudiants inscrits", label2:"ressources numérisées", label3:"quiz disponibles", label4:"élèves du secondaire" },
    ...
    cta: { title:"Rejoins les 25 000+ étudiants\nqui réussissent avec VALIDE.", subtitle:"Gratuit. Simple. Accessible partout au Cameroun.", btn_app:"Télécharger l'app", btn_web:"Essayer la version web →" },
    footer: { tagline:"L'éducation de qualité,\naccessible à tous au Cameroun.", nav_title:"Navigation", nav_home:"Accueil", nav_about:"À propos", nav_platforms:"Plateformes", nav_impact:"Réalisations", nav_team:"Équipe", platforms_title:"Plateformes", copyright:"© 2025 VALIDE — Tous droits réservés", legal:"Mentions légales", privacy:"Confidentialité" }
  },
  en: {
    nav: { about:"About", platforms:"Platforms", impact:"Achievements", team:"Team", contact:"Contact us" },
    hero: { title:"Quality education,", highlight:"accessible to all.", subtitle:"Thousands of learning resources, smart quizzes and an AI assistant — free of charge, for every Cameroonian student.", play_store:"Play Store", app_store:"App Store", stat_students:"students", stat_resources:"resources", stat_free:"100% Free" },
    ...
    stats: { label1:"registered students", label2:"digitised resources", label3:"available quizzes", label4:"secondary school students" },
    ...
    cta: { title:"Join 25,000+ students\nwho succeed with VALIDE.", subtitle:"Free. Simple. Accessible everywhere in Cameroon.", btn_app:"Download the app", btn_web:"Try the web version →" },
    footer: { tagline:"Quality education,\naccessible to all in Cameroon.", nav_title:"Navigation", nav_home:"Home", nav_about:"About", nav_platforms:"Platforms", nav_impact:"Achievements", nav_team:"Team", platforms_title:"Platforms", copyright:"© 2025 VALIDE — All rights reserved", legal:"Legal notice", privacy:"Privacy" }
  }
};
